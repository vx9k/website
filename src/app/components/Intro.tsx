 ...
 *  facts are a pane of label-over-value cells: stacked on phones, side by
 *  side from sm up. The grid is pulled out by a pixel and clipped, so only
 *  the inner rules show. */
  ...
  return (
    <div className="shell split pt-20 pb-24 sm:pt-28 lg:grid lg:pt-36 lg:pb-28">
      ...
      <div className="glass mt-14 overflow-hidden lg:col-start-2">
        <dl className="-m-px grid sm:grid-cols-2">
