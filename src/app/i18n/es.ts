...
const es: Dictionary = {
  ...
  display: {
    ...
    day: { label: "Luz de día", hint: "La pantalla menta en lugar de la oscura" },
    motion: { label: "Reducir movimiento", hint: "Desactiva las animaciones" },
    large: { label: "Texto más grande", hint: "Letra 25% más grande" },
  },
  scene: {
    hint: "Algunos píxeles hacen cosas: prueba el sol o la luna, la cabaña y la fogata. O pulsa Jugar y recorre la página.",
  ...
  console: {
    power: "Encendido",
    label: "Consola de bolsillo",
    start: "Start",
    select: "Select",
    startLabel: "Start: jugar la página",
    selectLabel: "Select: cambiar la paleta",
  },
  game: {
    play: "Jugar",
    stop: "Parar",
    character: "Jugar: recorre la página con este personaje",
    region: "Juego",
    help: "← → caminar. ↑ o Espacio salta; dos veces, doble salto. ↓ baja por una cornisa. X toca la cabaña y la fogata. Esc para.",
    helpTouch: "◀ ▶ caminar. A salta; dos veces, doble salto. ▼ baja por una cornisa. B toca la cabaña y la fogata.",
    found: "{n} de {total} gemas encontradas",
    allFound: "Encontraste todas las gemas. Gracias por jugar.",
    pad: { left: "Izquierda", right: "Derecha", up: "Saltar", down: "Bajar", a: "Saltar", b: "Tocar" },
  },
  offline: {
  ...
  work: {
    ...
    site: {
      eyebrow: "Este sitio",
      body: "Un export estático de Next.js servido desde Cloudflare Workers. Las montañas de la portada son pixel art: se generan al compilar el sitio y llegan como un único SVG, sin scripts. La página te avisa cuando te quedas sin conexión, cambia de paleta cuando tocas el sol, se puede jugar con un pequeño personaje y está en inglés, español y portugués.",
    },
  },
  stack: {
    kicker: "Herramientas",
