...
const pt: Dictionary = {
  ...
  display: {
    ...
    day: { label: "Luz do dia", hint: "A tela menta no lugar da escura" },
    motion: { label: "Reduzir movimento", hint: "Desliga as animações" },
    large: { label: "Texto maior", hint: "Letras 25% maiores" },
  },
  scene: {
    hint: "Alguns pixels fazem coisas: experimente o sol ou a lua, a cabana e a fogueira. Ou aperte Jogar e percorra a página.",
  ...
  console: {
    power: "Ligado",
    label: "Console de bolso",
    start: "Start",
    select: "Select",
    startLabel: "Start: jogar a página",
    selectLabel: "Select: trocar a paleta",
  },
  game: {
    play: "Jogar",
    stop: "Parar",
    character: "Jogar: percorra a página com este personagem",
    region: "Jogo",
    help: "← → andar. ↑ ou Espaço pula; duas vezes, pulo duplo. ↓ desce por uma plataforma. X mexe na cabana e na fogueira. Esc para.",
    helpTouch: "◀ ▶ andar. A pula; duas vezes, pulo duplo. ▼ desce por uma plataforma. B mexe na cabana e na fogueira.",
    found: "{n} de {total} gemas encontradas",
    allFound: "Todas as gemas encontradas. Valeu por jogar.",
    pad: { left: "Esquerda", right: "Direita", up: "Pular", down: "Descer", a: "Pular", b: "Mexer" },
  },
  offline: {
  ...
  work: {
    ...
    site: {
      eyebrow: "Este site",
      body: "Um export estático de Next.js servido pelo Cloudflare Workers. As montanhas no topo da página são pixel art: geradas no build do site e entregues como um único SVG, sem scripts. A página avisa quando você fica offline, troca de paleta quando você toca o sol, pode ser jogada com um pequeno personagem e está em inglês, espanhol e português.",
    },
  },
  stack: {
    kicker: "Ferramentas",
